...
const whyUs = [
  {
    icon: Car,
    title: "รถบ้านแท้ 100%",
    desc: "คัดสรรรถคุณภาพดีจากเจ้าของขายตรง ไม่ผ่านคนกลาง",
  },
  {
    icon: Shield,
    title: "รับประกัน 1 ปี",
    desc: "รับประกันเครื่องยนต์และเกียร์ไม่จำกัดกิโลเมตร",
  },
  {
    icon: Zap,
    title: "ฟรีดาวน์ 0%",
    desc: "ออกรถได้ไม่ต้องวางเงินดาวน์ ตามเงื่อนไขไฟแนนซ์",
  },
  {
    icon: Truck,
    title: "ส่งฟรีทั่วไทย",
    desc: "บริการส่งรถถึงบ้านฟรีทุกจังหวัด",
  },
  {
    icon: FileCheck,
    title: "เอกสารครบถ้วน",
    desc: "มีเล่มทะเบียน พร้บ. เอกสารถูกต้องตามกฎหมาย",
  },
  {
    icon: Clock,
    title: "อนุมัติไว",
    desc: "ไฟแนนซ์หลายสถาบัน เครดิตดีออกรถ 0 บาท*",
  },
];
  ...
  return (
    <div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 relative">
            ...
            <div className="w-full">
              ...
              <div className="flex flex-row sm:flex-wrap gap-2 sm:gap-3 mt-6 pb-1">
                ...
                >
                  <Car size={16} className="shrink-0 sm:hidden" />
                  <Car size={18} className="shrink-0 hidden sm:block" />
                  <span className="inline sm:hidden">ซื้อรถ</span>
                  <span className="hidden sm:inline">เลือกซื้อรถยนต์</span>
                </Link>
                <Link
                  href="/sell-car"
                ...
                >
                  ...
                  <Wallet size={18} className="shrink-0 hidden sm:block" />
                  <span className="inline">ฝากขายรถ</span>
                </Link>
                <a
                  href="tel:0947251267"
                ...
                >
                  <Phone size={16} className="shrink-0 sm:hidden" />
                  <Phone size={18} className="shrink-0 hidden sm:block" />
                  <span className="inline">โทรเลย</span>
                </a>
              </div>
            </div>
          </div>
      ...
      <section className="container-responsive mt-6 sm:mt-8">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <div>
            ...
            <p className="text-slate-500 text-xs sm:text-sm mt-0.5">
              คัดสรรมาเพื่อคุณโดยเฉพาะ ผ่านการตรวจสอบอย่างละเอียด
            </p>
          </div>
          <Link
            href="/cars"
            className="text-brand-blue font-semibold text-sm hover:underline whitespace-nowrap ml-4"
          >
            ดูทั้งหมด →
          </Link>
        </div>
        <Suspense
          fallback={
            <div className="h-96 w-full animate-pulse bg-slate-100 rounded-xl" />
          }
        >
          <HomeFeaturedCars />
        </Suspense>
        ...
        <div className="container-responsive">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="mt-2 text-slate-500 text-sm sm:text-base">
              เลือกช่วงราคาหรือยี่ห้อที่สนใจ ให้เราช่วยหารถที่ใช่สำหรับคุณ
            </p>
          </div>
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {priceRanges.map((r) => (
                    <li key={r.query}>
                      ...
                      >
                        <span className="text-sm font-semibold text-slate-600 group-hover:text-white">
                          {r.label}
                        </span>
                      </Link>
                    </li>
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {brands.map((b) => (
                    <li key={b}>
                      ...
                      >
                        <span className="text-sm font-semibold text-slate-600 group-hover:text-brand-dark">
                          {b}
                        </span>
                      </Link>
                    </li>
          ...
          <div className="mt-8 sm:mt-10 text-center">
            <Link
              href="/cars"
              className="inline-flex items-center gap-2 bg-brand-dark text-white px-8 py-3 rounded-full font-bold hover:bg-gray-800 transition-colors shadow-lg shadow-brand-dark/20"
            >
      ...
      <section className="container-responsive mt-12 sm:mt-16">
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-brand-dark">
            ทำไมต้องเลือกน้ำเปล่ารถสวย?
          </h2>
          <p className="text-slate-500 mt-2 text-sm">
            ศูนย์รวมรถบ้านคุณภาพดี คัดสรรคุณภาพทุกคัน ตรวจสอบโดยผู้เชี่ยวชาญ
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
          {whyUs.map((f) => (
            <div
              key={f.title}
              className="rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-200 p-4 sm:p-5 flex gap-3 sm:gap-4 items-start bg-brand-blue border-brand-blue/30"
            >
      ...
      <section className="container-responsive mt-12 sm:mt-16 py-10">
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="mt-2 text-slate-500 text-sm sm:text-base">
            ข้อสงสัยยอดฮิตเกี่ยวกับการออกรถมือสองกับเรา
          </p>
        </div>
        <div className="max-w-3xl mx-auto space-y-4">
          {[
            {
              q: "ติดแบล็คลิสต์ หรือบูโร สามารถออกรถได้ไหม?",
              a: "สามารถออกรถได้ครับ ทางเรามีทีมงานผู้เชี่ยวชาญด้านไฟแนนซ์คอยให้คำปรึกษาและช่วยดันเคสให้ผ่านตามเงื่อนไขที่กำหนด",
            },
            {
              q: "ไม่มีคนค้ำประกัน ออกรถได้ไหม?",
              a: "ได้ครับ หากลูกค้ามีฐานเงินเดือนและอายุงานเข้าเกณฑ์ของทางไฟแนนซ์ ก็สามารถออกรถคนเดียวโดยไม่ต้องใช้คนค้ำประกันได้ครับ",
            },
            {
              q: "รถทุกคันมีการรับประกันไหม?",
              a: "รับประกัน 1 ปีเต็มครับ! ครอบคลุมทั้งเครื่องยนต์และเกียร์ (ไม่จำกัดระยะทาง) พร้อมบริการช่วยเหลือฉุกเฉิน 24 ชั่วโมง",
            },
            {
              q: "มีบริการจัดส่งรถต่างจังหวัดไหม?",
              a: "เรามีบริการจัดส่งรถฟรีทั่วประเทศไทยครับ ด้วยรถสไลด์ที่ปลอดภัย ส่งตรงถึงหน้าบ้านท่านแน่นอน",
            },
          ].map((faq, idx) => (
            <div
              key={idx}
              className="bg-white border border-slate-200 rounded-xl p-5 hover:border-brand-blue/50 transition-colors"
            >
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            <div>
              <h2 className="text-lg sm:text-2xl font-black">
                อยากขายรถ? ประเมินราคาฟรี รับซื้อทันที
              </h2>
              <p className="mt-1 sm:mt-2 text-white/80 text-sm">
                ราคายุติธรรม จ่ายเงินสดทันที ดำเนินการเอกสารให้ครบถ้วน
              </p>
            </div>
